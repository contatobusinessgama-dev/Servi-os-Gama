        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 hover:border-gama-orange/20 transition-all duration-300 hover:shadow-xl group">
              ...
              <div className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 hover:border-gama-blue/20 transition-all duration-300 hover:shadow-xl group">
          ...
          <div className="space-y-8">
            ...
            <div className="relative group rounded-[3.5rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(13,44,84,0.15)] border-8 border-slate-50 aspect-[4/3] sm:aspect-video lg:aspect-[4/3]">
              ...
              {/* Elementos Decorativos de Linha (Match no logo) */}
              ...
              {/* Floating Badge (Anos de Experiência / Selo de Qualidade) */}
